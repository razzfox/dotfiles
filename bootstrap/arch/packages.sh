...
FILESYS="dosfstools gptfdisk nfs-utils exfat-utils fuse fuse-exfat ntfsprogs ntfs-3g hfsprogs smartmontools"
...
PACKAGES="BASE SHELLS UTILS LANG FILESYS NETWORK BLUETOOTH LAPTOP VIDEO VIDEONV VIDEOATI EFIBOOT WIRELESS DESKTOP SERVER PRINTER TERM OTHER AUDIO MEDIA FONTS"
